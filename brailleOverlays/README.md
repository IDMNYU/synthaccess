...
This certainly saves space (46 characters instead of 61). On the downside, however, a braille user who reads in another language might not be able to read it.
